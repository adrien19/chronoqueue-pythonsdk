...
This version demonstrates the AsyncChronoqueueClient with full async/await support.
...
app = FastAPI(
    ...
    description="Demonstrates AsyncChronoqueueClient with full async/await support",
    version="2.0.0-async",
)

# Initialize async client
async_client: AsyncChronoqueueClient = None
...
async def get_async_client() -> AsyncChronoqueueClient:
    """
    Get or create AsyncChronoQueue client with TLS if certificates exist.
...
async def monitor_heartbeats_async(client: AsyncChronoqueueClient):
    """
...
async def shutdown_event():
    ...
    if async_client:
        logger.info("=" * 80)
        logger.info("🛑 Shutting down AsyncChronoQueue client...")
        ...
        logger.info("✅ AsyncChronoQueue client closed successfully")
        logger.info("=" * 80)
...
async def root():
    ...
    return {
        ...
        "client_type": "AsyncChronoqueueClient",
        "features": [
            "Non-blocking I/O operations",
