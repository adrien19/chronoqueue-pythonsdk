...
def mock_chronoqueue_client():
    """Mock ChronoqueueClient for testing."""
    with patch("api.routes.store.ChronoqueueClient") as mock_client_class:
        mock_client = Mock()
...
class TestStoreAPI:
    ...
    def test_post_cart_items_success(self, client, mock_chronoqueue_client):
        ...
        mock_chronoqueue_client.post_message.return_value = mock_response
    ...
    def test_get_queue_stats_success(self, client, mock_chronoqueue_client):
        ...
        mock_chronoqueue_client.get_queue.return_value = mock_response
    ...
    def test_get_queue_stats_not_found(self, client, mock_chronoqueue_client):
        """Test getting stats for non-existent queue."""
        mock_chronoqueue_client.get_queue.side_effect = Exception("Queue not found")
    ...
    def test_list_queues_success(self, client, mock_chronoqueue_client):
        """Test listing queues."""
        mock_response = Mock()
        mock_response.to_dict.return_value = {
            "queues": [
        ...
        mock_chronoqueue_client.list_queues.return_value = mock_response
    ...
    def test_list_queues_with_prefix(self, client, mock_chronoqueue_client):
        ...
        mock_chronoqueue_client.list_queues.assert_called_once_with(prefix="store", limit=100)

    def test_get_pending_messages_count(self, client, mock_chronoqueue_client):
    ...
    def test_delete_queue_success(self, client, mock_chronoqueue_client):
        """Test deleting a queue."""
        mock_response = Mock()
        mock_response.to_dict.return_value = {"success": True}
        mock_chronoqueue_client.delete_queue.return_value = mock_response
        ...
        mock_chronoqueue_client.delete_queue.assert_called_once_with(name="test-queue")
